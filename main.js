...
const myApiKey = "cec7f8c3"; // <<-- ADD YOUR API KEY HERE. DELETE THIS KEY before uploading your code on Github or Brightspace, 
    ...
    try {
        ...
        if(response.ok) {
            ...
            if (filteredMovies.length === 0) {
                createEmptyView(); 
               } else for (let movie of filteredMovies) {
...
function createMovieCard(movie) {
    ...
    const img = createHtmlElement('img', ['moviePoster']); 
